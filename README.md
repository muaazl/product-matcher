...
-   `TaggingSheet`: The sheet containing the SKUs you want to tag. (Note: This is hard-coded and must be changed in the script if you use a different sheet name).
...
4.  The script will run and place the results in the `TaggingSheet` sheet, starting from column B.
